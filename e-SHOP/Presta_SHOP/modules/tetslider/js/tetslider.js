...
if (typeof(tetslider_speed) == 'undefined')
		tetslider_speed = 400;
if (typeof(tetslider_pause) == 'undefined')
		tetslider_pause = 3000;
if (typeof(tetslider_loop) == 'undefined')
		tetslider_loop = true;
if (typeof(tetslider_width) == 'undefined')
        tetslider_width = 15;
if (typeof(tetslider_items) == 'undefined')
        tetslider_items = 1;
if (typeof(tetslider_thumb) == 'undefined')
        tetslider_thumb = 5;
if (typeof(tetslider_control) == 'undefined')
		tetslider_control = true;
if (typeof(tetslider_vert) == 'undefined')
		tetslider_vert = true;
		
	$('#imageGallery').lightSlider({
		gallery:true,
		item: tetslider_items,
		thumbItem: tetslider_thumb,
		speed: tetslider_speed,
		pause: tetslider_pause,
		controls: tetslider_control,
		thumbMargin: tetslider_width,
		pager: tetslider_vert,
		vertical: false,
		auto: tetslider_loop,
		animateThumb: true,
		slideMargin:0,
                ...
                refresh.createPager = function () {
                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        if (settings.gallery === true) {
                            pagers += '<li style="width:100%;' + property + ':' + thumbWidth + 'px;' + gutter + ':' + settings.thumbMargin + 'px"><a href="javascript:void(0)"><img src="http://newpstheme.com/modules/tetslider/js/'&#32;+&#32;thumb&#32;+&#32;'" /></a></li>';
                        } else {
