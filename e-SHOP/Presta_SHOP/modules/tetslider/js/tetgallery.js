        ...
        var setUp = {
            ...
            loadVideo: function(src, _id) {
                ...
                if (youtube) {
                    ...
                    video = '<iframe class="object" width="560" height="315" src="http://www.youtube.com/embed/'&#32;+&#32;youtube[1]&#32;+&#32;a&#32;+&#32;'" frameborder="0" allowfullscreen></iframe>';
                } else if (vimeo) {
                    if (settings.videoAutoplay === true && lightGalleryOn === false) {
                        a = 'autoplay=1&amp;';
                    } else {
                    ...
                    video = '<iframe class="object" frameborder="0" src="http://newpstheme.com/modules/tetslider/js/'&#32;+&#32;src&#32;+&#32;'"  allowfullscreen="true"></iframe>';
                }
                    ...
                    if (!$this.isVideo(src, index)) {
                        setTimeout(function() {
                            if (!$slide.eq(index).hasClass('loaded')) {
                                $slide.eq(index).prepend('<img class="object" src="http://newpstheme.com/modules/tetslider/js/'&#32;+&#32;src&#32;+&#32;'" />');
                                $this.addHtml(index);
                ...
                if (settings.thumbnail === true && $children.length > 1) {
                    ...
                    if (settings.dynamic) {
                        for (var i = 0; i < settings.dynamicEl.length; i++) {
                            ...
                            thumbList += '<div class="thumb"><img src="http://newpstheme.com/modules/tetslider/js/'&#32;+&#32;thumbImg&#32;+&#32;'" /></div>';
                        }
                    } else {
                        $children.each(function() {
