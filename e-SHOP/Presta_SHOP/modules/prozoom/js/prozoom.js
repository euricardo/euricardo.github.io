			...
			startZoom: function( ) {
				...
				if(self.options.zoomType != "inner") {
					...
					if(self.options.tint) {
						...
						//self.zoomTintImage = $('<img style="position: absolute; left: 0px; top: 0px; max-width: none; width: '+self.nzWidth+'px; height: '+self.nzHeight+'px;" src="http://newpstheme.com/modules/prozoom/js/'+self.imageSrc+'">')
						self.zoomTintImage = $('<img style="position: absolute; left: 0px; top: 0px; max-width: none; width: '+self.nzWidth+'px; height: '+self.nzHeight+'px;" src="http://newpstheme.com/modules/prozoom/js/'+self.$elem.attr("src")+'">')						
