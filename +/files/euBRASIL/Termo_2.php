...
<br><br>
    ...
    <div id="painel" style="text-align: center; font: 15px Tahoma; cursor: default; height: 650px; width: 450px; overflow: hidden; background-color: #DFEDFE; padding-left: 0px;  padding-right: 0px" onmouseover="Parar()" onmouseout="Rolar()">
