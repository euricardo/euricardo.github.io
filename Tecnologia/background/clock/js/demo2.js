(function() {
	...
	var tnav = new TabsNav(document.querySelector('nav.tabsnav'), {
		...
		bgCtrl = document.querySelectorAll('.tabsnav__bar'),
	...
	function openTabCallback(anim, idx, tab) {
		if( anim.progress > 10 && !isContentShown ) {
			...
			bgCtrl[idx].style.backgroundColor = "rgba(0,0,0,0.5)";
	...
	function closeTabs() {
		...
		anime({
			...
			update: function(anim) {
				...
				bgCtrl[current].style.backgroundColor = "rgba(255,255,255,0.14)";
