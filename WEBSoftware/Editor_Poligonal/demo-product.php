...
<div class="inner-page-header">
    <div class="container">
        ...
        <p>The following demo is just one example of how you can use Image Map Pro’s API to create awesome interactive experiences for your visitors. It also showcases how you can have multiple vector shapes connected together.</p>
    </div>
</div>

<section class="inner-page-section">
    <div class="container">
        <div id="image-map-product-text" class="col-md-6">
            <article id="article-payload" data-imp-highlight-shape-on-mouseover="payload">
                <h3>Payload</h3>
                <p>Falcon Heavy missions will deliver large payloads to orbit inside a composite fairing, but the rocket can also carry the Dragon spacecraft.</p>
                <div class="line" id="line-payload"></div>
            </article>
            <article id="article-second-stage" data-imp-highlight-shape-on-mouseover="second stage">
                <h3>Second Stage</h3>
                <p>Falcon Heavy draws upon Falcon 9’s proven design, which minimizes stage separation events and maximizes reliability. The second-stage Merlin engine, identical to its counterpart on Falcon 9, delivers the rocket’s payload to orbit after the main engines cut off and the first-stage cores separate. The engine can be restarted multiple times to place payloads into a variety of orbits including low Earth, geosynchronous transfer orbit (GTO) and  geosynchronous orbit (GSO).</p>
                <div class="line" id="line-second-stage"></div>
            </article>
            <article id="article-first-stage" data-imp-highlight-shape-on-mouseover="first stage">
                <h3>First Stage</h3>
                <p>Three cores make up the first stage of Falcon Heavy. The side cores, or boosters, are connected  at the base and at the top of the center core’s liquid oxygen tank. The three cores, with a total of 27 Merlin engines, generate 22,819 kilonewtons (5.13 million pounds) of thrust at liftoff. Shortly after liftoff the center core engines are throttled down. After the side cores separate, the center core engines throttle back up to full thrust.</p>
                <div class="line" id="line-first-stage"></div>
            </article>
            <article id="article-boosters" data-imp-highlight-shape-on-mouseover="booster 1">
                <h3>Boosters</h3>
                <p>Each of Falcon Heavy’s side cores, or boosters, is equivalent to the first stage of a Falcon 9 rocket with nine Merlin engines. At liftoff, the boosters and the center core all operate at full thrust. Shortly after liftoff, the center core engines are throttled down. After the side cores separate, the center core engines throttle back up.</p>
                <div class="line" id="line-boosters"></div>
            </article>
            <article id="article-cores" data-imp-highlight-shape-on-mouseover="engines 1">
                <h3>Three Nine-Engine Cores</h3>
                <p>Inside each of Falcon Heavy’s three cores is a cluster of nine Merlin engines.  These same engines power Falcon 9, enabling efficiencies that make Falcon Heavy the most cost-effective heavy-lift launch vehicle in the world. With a total of 27 first-stage engines, Falcon Heavy has engine-out capability that no other launch vehicle can match—under most payload scenarios, it can sustain more than one unplanned engine shutdown at any point in flight and still successfully complete its mission.</p>
                <div class="line" id="line-cores"></div>
            </article>
        </div>
        <div id="image-map-product" class="col-md-6"></div>
    </div>
</section>
