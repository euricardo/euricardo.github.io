...
<div class="inner-page-header">
    <div class="container">
        <span>Example</span>
        <h2>Mall Floor Plan</h2>
        <p>This demo showcases some of the key features of Image Map Pro™ - shapes menu, zooming and multiple floors. The base image is a PNG and the mouseover effect uses vector shapes drawn in the Image Map Pro™ Editor.</p>
    </div>
</div>

<section class="inner-page-section">
    <div class="container">
        <div id="image-map-mall-top">
            <div class="image-map-mall-tooltip" id="image-map-mall-tooltip-fullscreen">Fullscreen</div>
            <div class="image-map-mall-tooltip" id="image-map-mall-tooltip-switch-floors">Switch Floors</div>
            <div class="image-map-mall-tooltip" id="image-map-mall-tooltip-search">Search</div>
        </div>
        <div id="image-map-mall"></div>
        <div id="image-map-mall-bottom">
            <div class="image-map-mall-tooltip" id="image-map-mall-tooltip-navigator">Navigator</div>
            <div class="image-map-mall-tooltip" id="image-map-mall-tooltip-zoom">Zoom</div>
            <div class="image-map-mall-tooltip" id="image-map-mall-tooltip-browse-and-select">Browse & Select</div>
        </div>
    </div>
</section>
...
<section class="inner-page-description">
    <div class="container">
        <div class="col-sm-4">
            <h3><i class="fa fa-list" aria-hidden="true"></i> Shapes Menu</h3>
            <p>If you have a lot of vector shapes or SVG icons on the image map, having a list of all locations is a nice boost to the usability and user experience. The menu has built-in search functionality and it can even be detached from the image map, so you can place it in the best place that suits your website.</p>
        </div>
        <div class="col-sm-4">
            <h3>
                <svg width="37px" height="37px" viewBox="0 0 37 37" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Artboard-Copy-16" transform="translate(-559.000000, -1239.000000)" fill="#FFFFFF" fill-rule="nonzero" stroke="#333333" stroke-width="3">
                            <g id="Group-11-Copy" transform="translate(559.000000, 1239.000000)">
                                <rect id="Rectangle-Copy-17" x="13.5" y="1.5" width="22" height="22" rx="5"></rect>
                                <rect id="Rectangle-Copy-16" x="7.5" y="7.5" width="22" height="22" rx="5"></rect>
                                <rect id="Rectangle" x="1.5" y="13.5" width="22" height="22" rx="5"></rect>
                            </g>
                        </g>
                    </g>
                </svg> Multiple Floors</h3>
            <p>Whether you are building a floor plan for a mall, plans of multiple apartments in a building or anything that might contain multiple vector maps - Image Map Pro™ can do it!</p>
        </div>
        <div class="col-sm-4">
            <h3><i class="fa fa-search-plus" aria-hidden="true"></i> Zoom and Pan</h3>
            <p>Do you have a massive vector map with a large number of shapes or SVG icons on it? No problem, it takes one click to enable zooming and/or fullscreen mode. Better user experience and you can still fit all the information you want on the map!</p>
        </div>
    </div>
</section>
